...
{
	if (region.a6.ay === region.bm.ay)
	{
		return 'on line ' + region.a6.ay;
	}
	return 'on lines ' + region.a6.ay + ' through ' + region.bm.ay;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b$: 'hidden', au: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b$: 'mozHidden', au: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b$: 'msHidden', au: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b$: 'webkitHidden', au: 'webkitvisibilitychange' }
		: { b$: 'hidden', au: 'visibilitychange' };
}
...
var author$project$Generation$Dead = 0;
var author$project$Generation$Gen = elm$core$Basics$identity;
...
var tortus$elm_array_2d$Array2D$repeat = F3(
	function (numRows, numColumns, e) {
		...
		return {
			o: numColumns,
			f: A2(elm$core$Array$repeat, numRows, row)
		};
	});
var author$project$Generation$repeat = F3(
	function (height, width, state) {
		return A3(tortus$elm_array_2d$Array2D$repeat, height, width, state);
	});
var author$project$Main$Initial = elm$core$Basics$identity;
...
var tortus$elm_array_2d$Array2D$getRow = F2(
	function (row, array2d) {
		return A2(elm$core$Array$get, row, array2d.f);
	});
var author$project$Generation$mapRowCells = F3(
	function (f, row, _n0) {
		var array = _n0;
		return elm$core$Array$toList(
			A2(
				...
				A2(
					...
					A2(tortus$elm_array_2d$Array2D$getRow, row, array))));
	});
...
var tortus$elm_array_2d$Array2D$rows = function (array2d) {
	return elm$core$Array$length(array2d.f);
};
var author$project$Generation$mapRows = F2(
	function (f, _n0) {
		var array = _n0;
		var rows = tortus$elm_array_2d$Array2D$rows(array);
		return A2(
			elm$core$List$map,
			f,
...
var author$project$Generation$flatten = F2(
	function (f, gen) {
		return A2(
			elm$core$List$concatMap,
			elm$core$Basics$apR(gen),
			A2(
				author$project$Generation$mapRows,
				author$project$Generation$mapRowCells(f),
				gen));
	});
...
var author$project$Main$cellColorFromState = function (state) {
	if (state === 1) {
		return A3(rtfeldman$elm_css$Css$rgb, 0, 0, 0);
	} else {
		return A3(rtfeldman$elm_css$Css$rgb, 0, 255, 255);
	}
};
...
var rtfeldman$elm_css$Css$inlineBlock = {g: 0, x: 'inline-block'};
...
var rtfeldman$elm_css$Css$solid = {n: 0, Q: 0, x: 'solid'};
...
var Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {V: charsProcessed, aa: hash, P: seed, ai: shift};
	});
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.aa | (c << data.ai);
		var _n0 = data.ai;
		if (_n0 === 24) {
			var newHash = Skinney$murmur3$Murmur3$step(
				A2(Skinney$murmur3$Murmur3$mix, data.P, res));
			return {V: data.V + 1, aa: 0, P: newHash, ai: 0};
		} else {
			return {V: data.V + 1, aa: res, P: data.P, ai: data.ai + 8};
		}
	});
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bk: elm$core$Maybe$Nothing, br: _List_Nil, bw: _List_Nil, bJ: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	...
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bk: charset, bX: declarations, br: imports, bw: namespaces};
};
	...
	function (declaration, _n0) {
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return elm$core$String$isEmpty(record.bW) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3(elm$core$Dict$insert, record.b5, record.bW, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bk: charset, bX: finalDeclarations, br: imports, bw: namespaces};
};
...
var author$project$Main$viewCell = F3(
	function (_n0, _n1, state) {
		var mystyle = rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					...
					author$project$Main$cellColorFromState(state))
				]));
		return A2(
...
var rtfeldman$elm_css$Css$auto = {bR: 0, a: 0, Y: 0, aO: 0, b3: 0, ac: 0, D: 0, v: 0, af: 0, s: 0, aV: 0, am: 0, q: 0, x: 'auto'};
var rtfeldman$elm_css$Css$block = {g: 0, x: 'block'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[mystyle]),
				A2(author$project$Generation$flatten, author$project$Main$viewCell, gen)),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[mystyle]),
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bp: fragment, bq: host, by: path, bA: port_, bD: protocol, bE: query};
	});
...
var elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			b2: function (_n0) {
				return _Utils_Tuple2(impl.b2, elm$core$Platform$Cmd$none);
			},
			cd: function (_n1) {
...
var author$project$Main$main = function () {
	var initState = A3(author$project$Generation$repeat, 1, 5, 0);
	return elm$browser$Browser$sandbox(
		{
			b2: initState,
			cf: author$project$Main$update,
			ci: A2(elm$core$Basics$composeR, author$project$Main$view, rtfeldman$elm_css$Html$Styled$toUnstyled)
		});
}();
